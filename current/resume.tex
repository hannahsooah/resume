...
\section{Education}
\subsection{University of California, Berkeley}\quad\textbf{Electrical Engineering and Computer Science, BS}\quad
{(Aug 2020 - Dec 2023)}\\
Coursework:
  Operating Systems,
  Algorithms,
...
\subsection{Software Engineer Intern (Analytics Platform)}
\entry{Addepar}{May 2023 - Aug 2023}{Mountain View, CA}
\begin{itemize}
  %\item Initiated conversations with finance and client solutions teams to identify a manual workflow to automate
  \item Automated a workflow by using Java and Python to classify assets and perform billing calculations
  \item Implemented a client-facing full-stack solution using Snowflake API to pipeline data to Looker dashboards
  \item Tested SQL database migrations on AWS EC2 instances using Jenkins to deploy to Kubernetes Comet pods
