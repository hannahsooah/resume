...
\begin{itemize}
  \item Reinforce student knowledge of machine architecture, high-level language support, and operating systems (I/O, interrupts, memory management, process switching) as a member of course staff
  \item Led weekly reviews for students; focus on conceptual application through projects, homework, and labs
\end{itemize}
...
Tools:
  Vim, Git, Mercurial, Terraform, Bash, Eclipse, IntelliJ, Spring Boot \\
Languages:
